...
var BASE_PACKAGE = {
  description: 'A full genesis node build with Bitcore',
  repository: 'https://github.com/genesis-extended/bitcore-node-genesis',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-genesis': 'genesis-extended/bitcore-lib-genesis',
    'bitcore-node-genesis': 'genesis-extended/bitcore-node-genesis'
  }
};
